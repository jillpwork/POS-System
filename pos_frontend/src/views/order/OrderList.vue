<template>
  <div>
    <div class="card-panel">
      <div class="row">
        <div class="col s8">
          <h4 style="margin:0px">Order List</h4>
        </div>
      ...
      <table class="striped">
        <thead>
          <tr>
            ...
            <th style="text-align:center;">
              Payment Status
              <!-- <div class="switch">
                <label><span style="color:red;">Pending</span>
                <input type="checkbox" v-model="search_payment_status" @change="getOrders">
                <span class="lever"></span><span style="color:green;">Paid</span>
                </label>
              </div> -->
            </th>
          </tr>
        ...
        <tbody>
          <tr v-if="orders.data.length <= 0">
            <td colspan="4" style="text-align:center;"><h5>No Orders Found</h5></td>
          </tr>
